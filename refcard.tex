...
\begin{center}
  {\Large \bf Carte de référence Programmation Objet C++20} \\
...
public:
    ...
    virtual ~Animal() {}
    virtual void crier() const = 0; // pure virtual
...
\item[Smart pointers] \texttt{unique\_ptr}, \texttt{shared\_ptr} pour la gestion automatique de la mémoire
\end{description}
